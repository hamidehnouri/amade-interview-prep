...
// inp/out = USD per 1M tokens. VERIFY current pricing on https://openrouter.ai/models
export const MODELS: ModelInfo[] = [
  ...
  { value: "google/gemma-4-31b-it", label: "Gemma 4 31B · open source", inp: 0.1, out: 0.3, reasoning: false },
];
